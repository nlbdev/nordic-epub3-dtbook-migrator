...
<p:declare-step xmlns:p="http://www.w3.org/ns/xproc" xmlns:c="http://www.w3.org/ns/xproc-step" xmlns:px="http://www.daisy.org/ns/pipeline/xproc" xmlns:d="http://www.daisy.org/ns/pipeline/data"
    ...
    xmlns:cx="http://xmlcalabash.com/ns/extensions" xmlns:html="http://www.w3.org/1999/xhtml" xmlns:opf="http://www.idpf.org/2007/opf">
        ...
        <p:when test="/*/text() = '2015-1'">
            ...
            <p:group name="epub3-to-dtbook.html-move">
                ...
                <p:output port="in-memory.out" sequence="true">
                    <p:pipe step="epub3-to-dtbook.html-move.inner" port="result.in-memory"/>
                </p:output>
                ...
                <px:fileset-copy name="epub3-to-dtbook.html-move.inner">
            ...
            <p:group name="epub3-to-dtbook.dtbook-move">
                <p:output port="fileset.out" primary="true"/>
                <p:output port="in-memory.out" sequence="true">
                    <p:pipe step="epub3-to-dtbook.dtbook-move.inner" port="result.in-memory"/>
                </p:output>
                <p:variable name="dirname" select="(//d:file[@media-type='application/x-dtbook+xml'], //d:file[@media-type='application/xhtml+xml'])[1]/replace(replace(@href,'.*/',''),'^(.+)\..*?$','$1')"/>
                <px:fileset-copy name="epub3-to-dtbook.dtbook-move.inner">
                    <p:with-option name="target" select="concat(if (ends-with(/*/text(),'/')) then /*/text() else concat(/*/text(),'/'), $dirname, '/')">
                        <p:pipe port="normalized" step="output-dir"/>
                    </p:with-option>
                    <p:input port="source.in-memory">
