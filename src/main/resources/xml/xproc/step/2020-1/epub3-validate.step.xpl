...
<p:declare-step xmlns:p="http://www.w3.org/ns/xproc"
    ...
    <p:option name="use-ace" required="false" select="'false'"/>
    ...
    <p:choose name="choose">
        ...
        <p:when test="/*/@result='ok' or $fail-on-error = 'false'">
            ...
            <px:message severity="DEBUG" message="Validating against nordic2020-1.opf.sch: $1">
            ...
            <p:validate-with-schematron name="epub3-validate.step.opf.validate.schematron" assert-valid="false">
                ...
                <p:input port="schema">
                    <p:document href="../../../schema/2020-1/nordic2020-1.opf.sch"/>
                </p:input>
            ...
            <p:for-each name="epub3-validate.step.for-each-html-validate">
                ...
                <px:nordic-html-validate.step.2020-1 name="epub3-validate.step.for-each-html-validate.validate.html" document-type="Nordic HTML (EPUB3 Content Document)" check-images="false">
                    <p:with-option name="fail-on-error" select="$fail-on-error"/>
                    <p:input port="in-memory.in">
                        <p:pipe port="in-memory" step="epub3-validate.step.unzip"/>
                    </p:input>
                </px:nordic-html-validate.step.2020-1>
                <p:identity>
                    <p:input port="source">
            ...
            <p:group name="epub3-validate.step.group-opf-and-html">
                ...
                <px:message severity="DEBUG" message="Validating against nordic2020-1.opf-and-html.sch: $1">
                ...
                <p:validate-with-schematron name="epub3-validate.step.group-opf-and-html.validate.schematron" assert-valid="false">
                    ...
                    <p:input port="schema">
                        <p:document href="../../../schema/2020-1/nordic2020-1.opf-and-html.sch"/>
                    </p:input>
                </p:validate-with-schematron>
                <p:sink/>
            ...
            <p:group name="epub3-validate.step.group-nav-references">
                <p:for-each name="epub3-validate.step.group-nav-references.iterate-html">
                    ...
                    <p:xslt name="epub3-validate.step.group-nav-references.iterate-html.list-heading-and-pagebreak-references">
                        ...
                        <p:input port="stylesheet">
                            <p:document href="../../../xslt/2020-1/list-heading-and-pagebreak-references.xsl"/>
                        </p:input>
                    </p:xslt>
                </p:for-each>
                ...
                <px:message severity="DEBUG" message="Validating against nordic2020-1.nav-references.sch: $1">
                    <p:with-option name="param1" select="replace(base-uri(/*),'.*/','')"/>
                </px:message>
                <p:validate-with-schematron name="epub3-validate.step.group-nav-references.iterate-html.nav-references.validate.schematron" assert-valid="false">
                    ...
                    <p:input port="schema">
                        <p:document href="../../../schema/2020-1/nordic2020-1.nav-references.sch"/>
                    </p:input>
                </p:validate-with-schematron>
                <p:sink/>
