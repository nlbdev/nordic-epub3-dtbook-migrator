...
<p:declare-step xmlns:p="http://www.w3.org/ns/xproc" xmlns:c="http://www.w3.org/ns/xproc-step" xmlns:px="http://www.daisy.org/ns/pipeline/xproc" type="nordic:set-doctype" version="1.0"
    xmlns:pxi="http://www.daisy.org/ns/pipeline/xproc/internal" xmlns:nordic="http://www.daisy.org/ns/pipeline/xproc/internal/nordic-epub3-dtbook-migrator" exclude-inline-prefixes="#all">
