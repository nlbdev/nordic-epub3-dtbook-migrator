...
<p:declare-step version="1.0" type="nordic:fileset-move" name="main" xmlns:c="http://www.w3.org/ns/xproc-step" xmlns:p="http://www.w3.org/ns/xproc" xmlns:px="http://www.daisy.org/ns/pipeline/xproc"
    xmlns:nordic="http://www.daisy.org/ns/pipeline/xproc/internal/nordic-epub3-dtbook-migrator" xmlns:d="http://www.daisy.org/ns/pipeline/data">
    ...
    <p:xslt name="moved-fileset">
        ...
        <p:input port="stylesheet">
            <p:document href="fileset-move.xsl"/>
        </p:input>
    </p:xslt>
