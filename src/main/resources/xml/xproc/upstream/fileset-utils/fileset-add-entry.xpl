...
<p:declare-step version="1.0" type="pxi:fileset-add-entry" name="main" xmlns:p="http://www.w3.org/ns/xproc" xmlns:d="http://www.daisy.org/ns/pipeline/data"
  xmlns:px="http://www.daisy.org/ns/pipeline/xproc" xmlns:pxi="http://www.daisy.org/ns/pipeline/xproc/internal/nordic-epub3-dtbook-migrator" exclude-inline-prefixes="px">
    ...
    <p:when
      ...
      <p:xslt>
        ...
        <p:input port="stylesheet">
          <p:document href="file-normalize.xsl"/>
        </p:input>
      </p:xslt>
    </p:when>
    <p:otherwise>
