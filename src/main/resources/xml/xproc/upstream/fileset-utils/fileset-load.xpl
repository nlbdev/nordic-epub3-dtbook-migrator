...
<p:declare-step version="1.0" type="nordic:fileset-load" name="main" xmlns:p="http://www.w3.org/ns/xproc" xmlns:d="http://www.daisy.org/ns/pipeline/data" xmlns:px="http://www.daisy.org/ns/pipeline/xproc"
  xmlns:pxi="http://www.daisy.org/ns/pipeline/xproc/internal/fileset-load" xmlns:nordic="http://www.daisy.org/ns/pipeline/xproc/internal/nordic-epub3-dtbook-migrator" xmlns:c="http://www.w3.org/ns/xproc-step" exclude-inline-prefixes="px">
  ...
  <p:for-each name="normalized">
    ...
    <nordic:fileset-add-entry name="normalized.fileset">
      <p:with-option name="href" select="$base-uri"/>
      <p:input port="source">
        <p:pipe port="result" step="fileset.in-memory-base"/>
      </p:input>
    </nordic:fileset-add-entry>
