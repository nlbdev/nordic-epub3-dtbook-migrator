...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2" xml:lang="en">
    ...
    <pattern id="epub_nordic_253_d">
        ...
        <rule context="html:figure[tokenize(@class, '\s+') = 'image']">
            <let name="figdesc-id" value=".//html:aside/@id" />
    ...
    <pattern id="epub_nordic_291">
        ...
        <rule context="html:section[tokenize(@epub:type, '\s+') = 'backmatter' and @role]">
            ...
            <assert test="tokenize(@role, '\s+') = ('doc-acknowledgments', 'doc-afterword', 'doc-appendix', 'doc-bibliography', 'doc-colophon', 'doc-conclusion', 'doc-dedication', 'doc-endnotes', 'doc-epigraph', 'doc-epilogue', 'doc-glossary', 'doc-index', 'doc-toc')">
                [nordic291] Backmatter can only use roles (doc-acknowledgments, doc-afterword, doc-appendix, doc-bibliography, doc-colophon, doc-conclusion, doc-dedication, doc-epigraph, doc-epilogue, doc-glossary, doc-index, doc-toc) <value-of select="$context"/>
            </assert>
        </rule>
    </pattern>
