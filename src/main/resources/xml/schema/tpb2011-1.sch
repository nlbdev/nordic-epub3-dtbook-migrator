...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern  id="dtbook_TPB_9">
  	<sch:rule context="dtbk:*">
  		<sch:report test="normalize-space(.)='' and not(*) and not(self::dtbk:img or self::dtbk:br or self::dtbk:meta or self::dtbk:link or self::dtbk:col or self::dtbk:th or self::dtbk:td or self::dtbk:dd or self::dtbk:pagenum[@page='special'])">[tpb09] Element may not be empty</sch:report>
  	</sch:rule>
  </sch:pattern>
...
<!--  		<sch:assert test="count(key('annorefs', @id))>=1">[tpb27] Each annotation must have at least one annoref</sch:assert>-->
  ...
  <sch:pattern id="dtbook_TPB_29b">
  	<sch:rule context="dtbk:*[self::dtbk:address    or self::dtbk:annotation or self::dtbk:author   or
  	  ...
  	  <sch:report test="following-sibling::dtbk:a      or following-sibling::dtbk:abbr or following-sibling::dtbk:acronym or following-sibling::dtbk:annoref or
  	                    ...
  	                    normalize-space(string-join(following-sibling::text(),''))!=''">Block element as sibling to inline element</sch:report>
  	  <sch:report test="preceding-sibling::dtbk:a      or preceding-sibling::dtbk:abbr or preceding-sibling::dtbk:acronym or preceding-sibling::dtbk:annoref or
  	                    ...
  	                    normalize-space(string-join(preceding-sibling::text(),''))!=''">[tpb29] Block element <sch:name/> as sibling to inline element</sch:report>
  	</sch:rule>
  </sch:pattern>
  ...
  <sch:pattern  id="dtbook_TPB_126">
  	<sch:rule context="dtbk:pagenum">
  		<sch:report test="preceding-sibling::*[1][self::dtbk:h1 or self::dtbk:h2 or self::dtbk:h3 or self::dtbk:h4 or self::dtbk:h5 or self::dtbk:h6] and
  		                  not(preceding-sibling::*[2][self::dtbk:pagenum])">[tpb126] pagenum must not occur directly after hx unless the hx is preceded by a pagenum</sch:report>
  	</sch:rule>
  </sch:pattern>
  ...
  <sch:pattern  id="dtbook_TPB_133">
  	<sch:rule context="dtbk:*[self::dtbk:link or self::dtbk:level or self::dtbk:epigraph or self::dtbk:byline or
  ...
  <sch:pattern  id="dtbook_TPB_135">
  	<sch:rule context="dtbk:*[self::dtbk:title or self::dtbk:author]">
  		<sch:assert test="parent::dtbk:poem">[tpb135] Element <sch:name/> is only allowed in poem context</sch:assert>
  	</sch:rule>
  	<sch:rule context="dtbk:poem">
  		<sch:assert test="dtbk:linegroup">[tpb135] Every poem must contain a linegroup</sch:assert>
  		<sch:report test="dtbk:line">[tpb135] Poem lines must be wrapped in a linegroup</sch:report>
  	</sch:rule>
  </sch:pattern>
  ...
  <sch:pattern  id="dtbook_TPB_141">
  	<sch:rule context="dtbk:prodnote[parent::dtbk:level1[@class='jacketcopy']]">
  		<sch:assert test="@class='frontcover' or @class='rearcover' or @class='leftflap' or @class='rightflap'">[tpb141] prodnote in jacket copy must have a class attribute with one of 'frontcover', 'rearcover', 'leftflap' or 'rightflap'</sch:assert>
  	</sch:rule>
  </sch:pattern>
