...
<xsl:transform xmlns:sch="http://purl.oclc.org/dsdl/schematron"
   ...
   <rdf:Description xmlns:dct="http://purl.org/dc/terms/"
      ...
      <dct:created>2022-11-11T09:09:53.705+01:00</dct:created>
   </rdf:Description>
      ...
      <schxslt:document>
         <schxslt:pattern id="d7e23">
            ...
            <xsl:for-each select="root()">
               <svrl:active-pattern xmlns:svrl="http://purl.oclc.org/dsdl/svrl" name="nav_references_1"
                                    id="nav_references_1">
         ...
         <schxslt:pattern id="d7e60">
            ...
            <xsl:for-each select="root()">
               <svrl:active-pattern xmlns:svrl="http://purl.oclc.org/dsdl/svrl" name="nav_references_2"
                                    id="nav_references_2">
                  <xsl:attribute name="documents" select="base-uri(.)"/>
               </svrl:active-pattern>
            </xsl:for-each>
         ...
         <schxslt:pattern id="d7e133">
            ...
            <xsl:for-each select="root()">
               <svrl:active-pattern xmlns:svrl="http://purl.oclc.org/dsdl/svrl" name="nav_references_3"
                                    id="nav_references_3">
                  <xsl:attribute name="documents" select="base-uri(.)"/>
               </svrl:active-pattern>
            </xsl:for-each>
         ...
         <schxslt:pattern id="d7e174">
            ...
            <xsl:for-each select="root()">
               <svrl:active-pattern xmlns:svrl="http://purl.oclc.org/dsdl/svrl" name="nav_references_4"
                                    id="nav_references_4">
                  <xsl:attribute name="documents" select="base-uri(.)"/>
               </svrl:active-pattern>
            </xsl:for-each>
