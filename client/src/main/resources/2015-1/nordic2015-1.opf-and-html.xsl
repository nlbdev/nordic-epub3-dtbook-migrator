...
<xsl:transform xmlns:sch="http://purl.oclc.org/dsdl/schematron"
   ...
   <rdf:Description xmlns:dct="http://purl.org/dc/terms/"
      ...
      <dct:created>2022-10-18T12:59:41.281+02:00</dct:created>
   </rdf:Description>
   ...
   <xsl:template name="d7e21">
      ...
      <schxslt:pattern id="d7e106">
         ...
         <xsl:for-each select="/">
            <svrl:active-pattern xmlns:svrl="http://purl.oclc.org/dsdl/svrl" id="nordic_opf_and_html_40">
               <xsl:attribute name="documents" select="base-uri(.)"/>
            </svrl:active-pattern>
         </xsl:for-each>
      </schxslt:pattern>
      ...
      <schxslt:pattern id="d7e277">
         ...
         <xsl:for-each select="/">
            <svrl:active-pattern xmlns:svrl="http://purl.oclc.org/dsdl/svrl" id="nordic_opf_and_html_32">
               <xsl:attribute name="documents" select="base-uri(.)"/>
            </svrl:active-pattern>
         </xsl:for-each>
      </schxslt:pattern>
      ...
      <schxslt:pattern id="d7e289">
         ...
         <xsl:for-each select="/">
            <svrl:active-pattern xmlns:svrl="http://purl.oclc.org/dsdl/svrl" id="nordic_opf_and_html_276">
               <xsl:attribute name="documents" select="base-uri(.)"/>
            </svrl:active-pattern>
         </xsl:for-each>
      </schxslt:pattern>
      ...
      <schxslt:rule pattern="d7e164">
         <xsl:choose>
            <xsl:when test="$schxslt:patterns-matched[. = 'd7e164']">
               <xsl:comment xmlns:svrl="http://purl.oclc.org/dsdl/svrl">WARNING: Rule for context "html:*[tokenize(@epub:type,'\s+')=('note','rearnote','footnote')]" shadowed by preceeding rule</xsl:comment>
               <svrl:suppressed-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
      ...
      <schxslt:rule pattern="d7e277">
         <xsl:choose>
            <xsl:when test="$schxslt:patterns-matched[. = 'd7e277']">
               <xsl:comment xmlns:svrl="http://purl.oclc.org/dsdl/svrl">WARNING: Rule for context "html:img[@longdesc]" shadowed by preceeding rule</xsl:comment>
               <svrl:suppressed-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
