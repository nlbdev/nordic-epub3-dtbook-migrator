...
<xsl:transform xmlns:sch="http://purl.oclc.org/dsdl/schematron"
   ...
   <rdf:Description xmlns:dct="http://purl.org/dc/terms/" xmlns:dc="http://purl.org/dc/elements/1.1/"
      ...
      <dct:created>2022-10-18T12:59:47.054+02:00</dct:created>
   </rdf:Description>
            ...
            <xsl:otherwise>
               ...
               <xsl:if test="count($navPoint) = 0">
                  <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" location="{schxslt:location(.)}">
                     ...
                     <svrl:text>[nordic_nav_ncx_1_a] toc items in the navigation document must also occur in the NCX. <xsl:value-of select="$context"/>
                     </svrl:text>
   ...
   <xsl:template match="html:a[ancestor::html:nav/tokenize(@epub:type,'\s+')='page-list']"
      ...
      <schxslt:rule pattern="d7e37">
         <xsl:choose>
            <xsl:when test="$schxslt:patterns-matched[. = 'd7e37']">
            ...
            <xsl:otherwise>
               ...
               <xsl:if test="count($pageTarget) = 0">
                  <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" location="{schxslt:location(.)}">
                     ...
                     <svrl:text>[nordic_nav_ncx_2_a] page references in the navigation document must also occur as pageTarget items in the NCX. <xsl:value-of select="$context"/>
                     </svrl:text>
                  </svrl:successful-report>
               </xsl:if>
            </xsl:otherwise>
      ...
      <xsl:next-match>
         <xsl:with-param name="schxslt:patterns-matched" as="xs:string*"
                         select="($schxslt:patterns-matched, 'd7e37')"/>
      </xsl:next-match>
   </xsl:template>
   <xsl:template match="ncx:navPoint" priority="6" mode="d7e17">
      <xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
      <xsl:variable name="context"
                    select="concat('(&lt;', name(), string-join(for $a in (@*) return concat(' ', $a/name(), '=&#34;', $a, '&#34;'), ''), '&gt;)')"/>
      ...
      <schxslt:rule pattern="d7e57">
         <xsl:choose>
            <xsl:when test="$schxslt:patterns-matched[. = 'd7e57']">
               <xsl:comment xmlns:svrl="http://purl.oclc.org/dsdl/svrl">WARNING: Rule for context "ncx:navPoint" shadowed by preceeding rule</xsl:comment>
               <svrl:suppressed-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
            ...
            <xsl:otherwise>
               ...
               <xsl:if test="count($navRef) = 0">
                  <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" location="{schxslt:location(.)}">
                     ...
                     <svrl:text>[nordic_nav_ncx_3_a] toc items in the NCX must also occur in the navigation document.<xsl:value-of select="$context"/>
                     </svrl:text>
                  </svrl:successful-report>
               </xsl:if>
   ...
   <xsl:template match="ncx:pageTarget" priority="5" mode="d7e17">
      <xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
      <xsl:variable name="context"
                    select="concat('(&lt;', name(), string-join(for $a in (@*) return concat(' ', $a/name(), '=&#34;', $a, '&#34;'), ''), '&gt;)')"/>
      <xsl:variable name="navRef"
                    select="/*/html:*[1]/html:body/html:nav[tokenize(@epub:type,'\s+')='page-list']//html:a[@href=current()/ncx:content/@src]"/>
      <schxslt:rule pattern="d7e117">
         <xsl:choose>
            <xsl:when test="$schxslt:patterns-matched[. = 'd7e117']">
               <xsl:comment xmlns:svrl="http://purl.oclc.org/dsdl/svrl">WARNING: Rule for context "ncx:pageTarget" shadowed by preceeding rule</xsl:comment>
               <svrl:suppressed-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
            ...
            <xsl:otherwise>
               ...
               <xsl:if test="count($navRef) = 0">
                  <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" location="{schxslt:location(.)}">
                     <xsl:attribute name="test">count($navRef) = 0</xsl:attribute>
                     <svrl:text>[nordic_nav_ncx_4_a] pageTarget items in the NCX must also occur as page references in the navigation document. <xsl:value-of select="$context"/>
                     </svrl:text>
                  </svrl:successful-report>
               </xsl:if>
      ...
      <xsl:next-match>
         <xsl:with-param name="schxslt:patterns-matched" as="xs:string*"
                         select="($schxslt:patterns-matched, 'd7e117')"/>
      </xsl:next-match>
   </xsl:template>
   <xsl:template match="html:a[ancestor::html:nav/tokenize(@epub:type,'\s+')='toc']"
                 priority="4"
      ...
      <xsl:variable name="context"
                    select="concat('(&lt;', name(), string-join(for $a in (@*) return concat(' ', $a/name(), '=&#34;', $a, '&#34;'), ''), '&gt;)')"/>
      <schxslt:rule pattern="d7e161">
         <xsl:choose>
            <xsl:when test="$schxslt:patterns-matched[. = 'd7e161']">
               <xsl:comment xmlns:svrl="http://purl.oclc.org/dsdl/svrl">WARNING: Rule for context "html:a[ancestor::html:nav/tokenize(@epub:type,'\s+')='toc']" shadowed by preceeding rule</xsl:comment>
               <svrl:suppressed-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
                  <xsl:attribute name="context">html:a[ancestor::html:nav/tokenize(@epub:type,'\s+')='toc']</xsl:attribute>
               </svrl:suppressed-rule>
            ...
            <xsl:otherwise>
               ...
               <xsl:if test="not(not(@href = preceding::html:a[ancestor::html:nav/tokenize(@epub:type,'\s+')='toc']/@href))">
                  <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" location="{schxslt:location(.)}">
                     <xsl:attribute name="test">not(@href = preceding::html:a[ancestor::html:nav/tokenize(@epub:type,'\s+')='toc']/@href)</xsl:attribute>
                     <svrl:text>[nordic_nav_ncx_5] Two references in the toc of the navigation document can not point to the same location in the content. <xsl:value-of select="$context"/>
                     </svrl:text>
                  </svrl:failed-assert>
               </xsl:if>
            </xsl:otherwise>
      ...
      <xsl:next-match>
         <xsl:with-param name="schxslt:patterns-matched" as="xs:string*"
                         select="($schxslt:patterns-matched, 'd7e161')"/>
      </xsl:next-match>
   </xsl:template>
   <xsl:template match="html:a[ancestor::html:nav/tokenize(@epub:type,'\s+')='landmarks']"
                 priority="3"
                 mode="d7e17">
      <xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
      <xsl:variable name="context"
      ...
      <schxslt:rule pattern="d7e161">
         <xsl:choose>
            <xsl:when test="$schxslt:patterns-matched[. = 'd7e161']">
               <xsl:comment xmlns:svrl="http://purl.oclc.org/dsdl/svrl">WARNING: Rule for context "html:a[ancestor::html:nav/tokenize(@epub:type,'\s+')='landmarks']" shadowed by preceeding rule</xsl:comment>
               <svrl:suppressed-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
                  <xsl:attribute name="context">html:a[ancestor::html:nav/tokenize(@epub:type,'\s+')='landmarks']</xsl:attribute>
               </svrl:suppressed-rule>
            </xsl:when>
            <xsl:otherwise>
               <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <xsl:if test="not(not(@href = preceding::html:a[ancestor::html:nav/tokenize(@epub:type,'\s+')='landmarks']/@href))">
                  <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" location="{schxslt:location(.)}">
                     <xsl:attribute name="test">not(@href = preceding::html:a[ancestor::html:nav/tokenize(@epub:type,'\s+')='landmarks']/@href)</xsl:attribute>
                     <svrl:text>[nordic_nav_ncx_5] Two references among the landmarks in navigation document can not point to the same location in the content. <xsl:value-of select="$context"/>
                     </svrl:text>
                  </svrl:failed-assert>
               </xsl:if>
            </xsl:otherwise>
      ...
      <schxslt:rule pattern="d7e189">
         <xsl:choose>
            <xsl:when test="$schxslt:patterns-matched[. = 'd7e189']">
               <xsl:comment xmlns:svrl="http://purl.oclc.org/dsdl/svrl">WARNING: Rule for context "ncx:navPoint | ncx:pageTarget" shadowed by preceeding rule</xsl:comment>
               <svrl:suppressed-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
            ...
            <xsl:otherwise>
               ...
               <xsl:if test="@href = (preceding::ncx:navPoint/@href | preceding::ncx:pageTarget/@href)">
                ...
                location in the content. <xsl:value-of select="$context"/>
                     </svrl:text>
                  </svrl:successful-report>
               </xsl:if>
            </xsl:otherwise>
   ...
   <xsl:template match="ncx:navLabel[parent::ncx:navMap]" priority="1" mode="d7e17">
      ...
      <xsl:variable name="context"
                    select="concat('(&lt;', name(), string-join(for $a in (@*) return concat(' ', $a/name(), '=&#34;', $a, '&#34;'), ''), '&gt;)')"/>
      <schxslt:rule pattern="d7e207">
         <xsl:choose>
            <xsl:when test="$schxslt:patterns-matched[. = 'd7e207']">
               <xsl:comment xmlns:svrl="http://purl.oclc.org/dsdl/svrl">WARNING: Rule for context "ncx:navLabel[parent::ncx:navMap]" shadowed by preceeding rule</xsl:comment>
               <svrl:suppressed-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
            ...
            <xsl:otherwise>
               ...
               <xsl:if test="not(normalize-space(string-join(.//text(),'')) = /*/html:*/html:body/html:nav[tokenize(@epub:type,'\s+')='toc']/*[matches(name(), 'h[1-6]')]/normalize-space(string-join(.//text(),'')))">
                  <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" location="{schxslt:location(.)}">
                     <xsl:attribute name="test">normalize-space(string-join(.//text(),'')) = /*/html:*/html:body/html:nav[tokenize(@epub:type,'\s+')='toc']/*[matches(name(), 'h[1-6]')]/normalize-space(string-join(.//text(),''))</xsl:attribute>
                     <svrl:text>[nordic_nav_ncx_7] The navLabel in the NCX navMap must correspond to the h[x] in the toc in the navigation document. The NCX navLabel has the value "<xsl:value-of select="normalize-space(string-join(.//text(),''))"/>", while the page-list h[x] in the navigation document <xsl:value-of select="(/*/html:*/html:body/html:nav[tokenize(@epub:type,'\s+')='toc']/*[matches(name(), 'h[1-6]')]/concat('has the value &#34;',normalize-space(string-join(.//text(),'')),'&#34;'), 'does not exist')[1]"/>.</svrl:text>
                  </svrl:failed-assert>
               </xsl:if>
            </xsl:otherwise>
         </xsl:choose>
      ...
      <xsl:next-match>
         <xsl:with-param name="schxslt:patterns-matched" as="xs:string*"
                         select="($schxslt:patterns-matched, 'd7e207')"/>
      </xsl:next-match>
   </xsl:template>
      ...
      <schxslt:rule pattern="d7e228">
         <xsl:choose>
            <xsl:when test="$schxslt:patterns-matched[. = 'd7e228']">
               <xsl:comment xmlns:svrl="http://purl.oclc.org/dsdl/svrl">WARNING: Rule for context "ncx:navLabel[parent::ncx:pageList]" shadowed by preceeding rule</xsl:comment>
               <svrl:suppressed-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
            ...
            <xsl:otherwise>
               ...
               <xsl:if test="not(normalize-space(string-join(.//text(),'')) = /*/html:*/html:body/html:nav[tokenize(@epub:type,'\s+')='page-list']/*[matches(name(), 'h[1-6]')]/normalize-space(string-join(.//text(),'')))">
                  <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" location="{schxslt:location(.)}">
                     <xsl:attribute name="test">normalize-space(string-join(.//text(),'')) = /*/html:*/html:body/html:nav[tokenize(@epub:type,'\s+')='page-list']/*[matches(name(), 'h[1-6]')]/normalize-space(string-join(.//text(),''))</xsl:attribute>
                     <svrl:text>[nordic_nav_ncx_8] The navLabel in the NCX pageList must correspond to the h[x] in the page-list in the navigation document. The NCX navLabel has the value "<xsl:value-of select="normalize-space(string-join(.//text(),''))"/>", while the page-list h[x] in the navigation document <xsl:value-of select="(/*/html:*/html:body/html:nav[tokenize(@epub:type,'\s+')='page-list']/*[matches(name(), 'h[1-6]')]/concat('has the value &#34;',normalize-space(string-join(.//text(),'')),'&#34;'), 'does not exist')[1]"/>.</svrl:text>
                  </svrl:failed-assert>
               </xsl:if>
            </xsl:otherwise>
         </xsl:choose>
