...
public class Guideline2020 extends Guideline {

    public Guideline2020() {
        schemaMap.put(CONTENT_FILES, new Schema("nordic2020-1.xsl", "Nordic HTML (EPUB3 Content Document)", ""));
        schemaMap.put(NAV_NCX, new Schema("nordic2020-1.nav-ncx.xsl", "Nordic EPUB3 NCX and Navigation Document", ""));
        schemaMap.put(NAV_REFERENCES, new Schema("nordic2020-1.nav-references.xsl",
            "Nordic EPUB3 Navigation Document References",
            "References from the navigation document to the content documents"
        ));
        schemaMap.put(OPF, new Schema("nordic2020-1.opf.xsl", "Nordic EPUB3 Package Document", ""));
        schemaMap.put(OPF_AND_HTML, new Schema("nordic2020-1.opf-and-html.xsl", "Nordic EPUB3 OPF+HTML", "Cross-document references and metadata"));
    ...
    public String getGuidelineName() {
        return "Nordic EPUB Guideline 2020-1";
    }

    @Override
    public String getNavReferenceTransformation() {
        return "/xslt/2020-1/list-heading-and-pagebreak-references.xsl";
    }
}
