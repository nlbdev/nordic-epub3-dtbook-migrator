...
<p:declare-step version="1.0" type="px:fileset-move" name="main" xmlns:c="http://www.w3.org/ns/xproc-step" xmlns:p="http://www.w3.org/ns/xproc" xmlns:px="http://www.daisy.org/ns/pipeline/xproc" xmlns:d="http://www.daisy.org/ns/pipeline/data">

    <!-- TODO: include this in Pipeline 2 v1.8 -->
